        ...
        if message["type"] == "close":
            ...
            if symbol in ["GS", "MS", "WFC", "XLF"]:
                ...
                if buy:
                    ...
                    sellOrders.append({"type":"add", "order_id": orderId, "symbol": symbol, "dir": "BUY", "price": buy[0][0] + 1, "size": 100})
                    orderId+=1
                    sellOrders.append({"type":"add", "order_id": orderId, "symbol": symbol, "dir": "SELL", "price": buy[0][0] + 10, "size": 100})
                    orderId += 1
            message = exchange.read_message()
